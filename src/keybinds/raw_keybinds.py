# - NOTE -
# This is copied directly from https://github.com/bl-sdk/oak-mod-manager/blob/master/src/keybinds/raw_keybinds.py
# only thing changed was the order of arguments in RawKeybindCallback_KeyAndEvent.
#
...
type RawKeybindCallback_KeyAndEvent = Callable[[EInputEvent, str], KeybindBlockSignal]
